<template>
  <div id="app">
    ...
    <div class="relative bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div class="-mr-2 -my-2 md:hidden">
            <button type="button" :class="{active: showMenu}" v-on:click.prevent="closeMenu()" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
          ...
          <nav class="hidden md:flex space-x-10">
            ...
            <router-link class="text-base font-medium text-gray-500 hover:text-gray-900" to="/">Home</router-link>
            <router-link class="text-base font-medium text-gray-500 hover:text-gray-900" to="/crypto">Crypto-monnaies</router-link>
            <router-link class="text-base font-medium text-gray-500 hover:text-gray-900" to="/erc20">ETH Explorer</router-link>
            <router-link class="text-base font-medium text-gray-500 hover:text-gray-900" to="/infos">Infos</router-link>
            <router-link class="text-base font-medium text-gray-500 hover:text-gray-900" to="/about">À propos</router-link>
      ...
      -->
      <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right z-40 md:hidden" :class="{active: showMenu}">
